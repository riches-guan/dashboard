...
var mani = {
    "name": "ICCControl Dashboard",
    "short_name": "Dashboard",
    "description": "A dashboard for ICCControl",
    "start_url": "./#/0",
...
function addBaseConfig(config) {
    ...
    mani.name = config.site ? config.site.name : "ICCControl 面板";
    mani.short_name = mani.name.replace("ICCControl","").trim();
